// Package diff provides functionality for comparing two sets of
// environment variables and reporting differences between them.
package diff
...
// Compare takes two env maps (e.g. staging vs production) and returns
// a Result describing all differences and commonalities.
...
// HasDifferences returns true if there is any difference between the two env maps.
